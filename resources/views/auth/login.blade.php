        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-0">
                            <a class="col-md-10 text-md-center pt-5">※アカウントをお持ちでない方はこちら</a>
                            <div class="col-md-8 offset-md-4">
                                <button type="button" class="btn btn-outline-primary" onclick="location.href= '{{ route('register') }}'">新規登録</button>
                            </div>
                    </div>
                </div>
            </div>
